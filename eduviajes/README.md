...
(Fraunces y Plus Jakarta Sans, licencia OFL) están incrustadas en el archivo.
...
- Hero animado: avión que sale del Monumento a la Bandera, parallax y cartel split-flap con destinos.
...
- Catálogo de 13 destinos con ilustraciones animadas, filtros por región y perfil, y mapa con rutas desde Rosario.
- Sección colegios: niveles, qué incluye, recorrido paso a paso con un micro que avanza al scrollear y formulario a WhatsApp.
...
- Sumar logo y fotos reales; quitar el banner y el selector de paleta y sacar `noindex` del `<head>`.
